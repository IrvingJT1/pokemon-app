...
export const PokeDetails = () => {
    ...
    //Se usa inline style debido a la limitacion de bootstrap con el parámetro top
    const top = {
    top: "55%"
    };
    ...
    return (
        ...
        <div className="container">
            ...
            <hr />
                ...
                <div className="card bg-dark text-white border-white w-25 mt-5 position-absolute start-50 translate-middle" style={top}>
